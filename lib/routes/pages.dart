...
import '../views/cover_letter/cover_letter_response_screen.dart';
import '../views/cover_letter/cover_letter_screen.dart';
...
class Pages {
  static var list = [
    ...
    GetPage(
      name: Routes.coverLetterScreen,
      page: () => CoverLetterScreen(),
    ),
    GetPage(
      name: Routes.coverLetterResponseScreen,
      page: () => CoverLetterResponseScreen(),
    ),
    GetPage(
